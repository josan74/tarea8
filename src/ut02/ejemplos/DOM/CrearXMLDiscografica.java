		...
		try{
			...
			document.setXmlVersion("1.0"); //asignamos la version de nuestro XML
				...
				for(Disco disco: discografica)	{
					...
					CrearElemento("titulo",disco.getTitulo(), raiz, document);// A�adir ID
					CrearElemento("formato",disco.getFormato().toString(),raiz, document);// A�adir apellido
					CrearElemento("autor",disco.getAutor(),raiz,document); //A�adir departamento
